<template>
  <div class="page" transition>
    <div class="spd-navbar" v-if="hasNavbar" ref="navbar">
      <div class="left">
        <a class="link" @click="back" v-if="!noBack">
    ...
    <div class="spd-tabbar" v-if="hasTabbar && tabbars && tabbars.length>0" ref="tabbar">
...
export default {
  ...
  methods: {
    ...
    setActive (newPage) {
      ...
      let tabbarNodes = this.$refs.tabbar
